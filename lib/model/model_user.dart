...
//if we want to make variable optional then put it within [] eg: [this.description]
  ...
  ModelUser.withoutId(this._name, this._email, this._mobile, this._password, this._userCode, this._imageUrl,this._date);
//below is named constructor
  ModelUser(this._id, this._name, this._email, this._mobile,
      this._password, this._userCode,this._imageUrl, this._date);
